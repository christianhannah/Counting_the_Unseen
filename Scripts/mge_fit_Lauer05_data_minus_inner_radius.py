...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 27 12:51:08 2021
...
# desc should be 'NGC', 'IC', or 'ESO'
def get_density_profile(desc,number):
...
# ======================== REPARE DATA FOR FIT ================================
    ...
    num_rad = 100
    rad = np.geomspace(np.min(SB_data['MajAxis'][1:]), np.max(SB_data['MajAxis'][1:]), num_rad)
    SBs_i = np.interp(rad, SB_data['MajAxis'][1:], SB_data['SuBr'][1:])
...
# ======================== DEPROJECT SB PROFILE================================
    ...
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pdfs/'+gal_name_nospace+'_mge_fit.pdf',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pngs/'+gal_name_nospace+'_mge_fit.png',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
    plt.clf()
...
#%%
    ...
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pdfs/'+gal_name_nospace+'_density_profile.pdf',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pngs/'+gal_name_nospace+'_density_profile.png',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
...
#%%
    ...
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pdfs/reconstructed_MGEs/'+gal_name_nospace+'_reconstructed_MGE_plot.pdf',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
    plt.savefig('/Users/christian/OneDrive/Desktop/TDE Code/Plots/Removed_Center_SB_data/MGE_FITS_and_DENSITIES_pngs/reconstructed_MGEs/'+gal_name_nospace+'_reconstructed_MGE_plot.png',
                bbox_inches='tight', pad_inches=0.1, dpi=500)
