...
p = u.find_nearest(q_discrete, 1)


k=60
plt.figure(dpi=500)
plt.plot(np.log10(e_DF[k:]),np.log10(F[k:]), label='Discrete',linewidth=3)
plt.plot(np.log10(e_DF[k:]),np.log10(F_analytic[k:]), label='Analytic')
plt.plot([np.log10(e_DF[p]),np.log10(e_DF[p])],[np.min(np.log10(F[k:])),np.max(np.log10(F_analytic[k:]))],
         color='k',linestyle='--')
plt.plot([np.log10(e_DF[-1]),np.log10(e_DF[-1])],[np.min(np.log10(F[k:])),np.max(np.log10(F_analytic[k:]))],
...
k=69
plt.figure(dpi=500)
plt.plot(np.log10(e_DF[k:]),np.log10((F[k:])/(F_analytic[k:])))
plt.plot([np.log10(e_DF[p]),np.log10(e_DF[p])],[np.min(np.log10((F[k:])/(F_analytic[k:]))),np.max(np.log10((F[k:])/(F_analytic[k:])))],
         color='k',linestyle='--')
plt.plot([np.log10(e_DF[-1]),np.log10(e_DF[-1])],[np.min(np.log10((F[k:])/(F_analytic[k:]))),np.max(np.log10((F[k:])/(F_analytic[k:])))],
         color='k',linestyle='--', label='q$\leq$1')
