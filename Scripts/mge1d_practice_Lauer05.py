...
#SBs_1 = np.interp(rad, SB_data['MajAxis'], SB_data['SuBr'])
#pdb.set_trace()
#%%
#print(u.get_density_and_slope(np.log10(SB_data['MajAxis']), np.log10(SB_data['SuBr'])))
#print(u.get_density_and_slope(np.log10(rad), np.log10(SBs_i)))
#%%
...
#%%
SB_slope, blah,blah,blah = u.get_density_and_slope(np.log10(radii), np.log10(SBs), scale, 10, 1)
#%%
#pdb.set_trace()
...
# get power_law_index and density at 2pc
slope, inner_dens = u.get_density_and_slope(np.log10(radii),np.log10(densities))
